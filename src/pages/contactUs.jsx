...
const ContactUs = () => {
    ...
    return (
        <>
            <InnerPageBanner heading="How can we assist you ?" subHeading="Contact us today" />
            <Container>
                <Row>
                    <Col>
                        <div md={6}>
                            ...
                            <Form noValidate validated={validated} onSubmit={handleSubmit}>
                                ...
                                <ButtonComponent type="submit" label="Submit">Submit</ButtonComponent>
                            </Form>
                        </div>
                    </Col>
                    ...
                    <Col className="gap-4">
                        <div md={6} className="space-y-4">
                            <div className="mb-5">
                                ...
                                <p className="my-3">
                                    Plot #T6,<br /> SIDCO Industrial Estate Kattur,<br /> Vellanoor Post,<br /> Chennai 600062, India
                                </p>
                                <iframe
                            ...
                            <div>
                                <h2 className="font-gas2 dark-blue">Oxair Pressure Vessels (Industrial)</h2>
                                <p className="my-3">
                                    Plot No 41,<br /> Auetta Industria Estate,<br /> Morai Village, Chennai No 41,<br /> Thiruvallur TN 600055, India
                                </p>
                                <iframe
                                    className="border p-2 w-100"
                                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3153.167158508069!2d144.96328511531697!3d-37.81421797975174!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6ad642af0f11fd81%3A0xf577b1b64c0a7fcb!2s0x6ad642af0f11fd81%3A0xf577b1b64c0a7fcb!5e0!3m2!1sen!2sin!4v1621513928826!5m2!1sen!2sin"
