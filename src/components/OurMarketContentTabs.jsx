...
import OilandGasImage from '../assets/images/oil&gas.png';
import PharmaChemicalImage from '../assets/images/pharmachemical.png';
...
const OurMarketsContentTabs = () => {
  const OurMarketTabs = [
    ...
    },
    {
      ...
      title: "Cutting",
      content:
        "Oxair India offers advanced oxygen generators for the metal-cutting industry, ensuring efficiency and precision in high-quality operations.",
      button: <ButtonComponent label={'View Product'} />
    },
    {
      eventKey: "oil",
    ...
    {
      eventKey: "chemical",
      icon: <Image src={PetroChemicalImage} alt="Chemical" width={50} height={50} />,
      title: "Chemical",
      content:
    ...
    {
      eventKey: "pharma",
      icon: <Image src={PharmaChemicalImage} alt="Pharma" width={50} height={50} />,
      title: "Pharma",
      content:
        "Oxair supplies oxygen and nitrogen generating systems and related equipment to the chemical and biotech industries for companies that require a reliable and continuous source of gas for their operations.",
      button: <ButtonComponent label={'View Product'} />
